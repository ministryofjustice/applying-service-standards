// Security configuration test: session cookie secure flag with HTTP base URL.
...
describe('Security configuration with auth enabled (HTTP base URL)', () => {
  it('configures session cookies with secure: false when BASE_URL does not start with "https://"', () => {
    require('../../index')
